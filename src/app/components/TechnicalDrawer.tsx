    ...
    >
      <div className="flex h-full flex-col">
        <header className="flex items-center justify-between border-b border-[#1F242C] px-5 py-4 sm:px-6">
          <h2 id={titleId} className="font-mono text-sm font-bold tracking-[0.12em] text-smidhus-bone sm:text-base">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-5 sm:px-6 sm:py-6">
          {loading ? (
            <p className="font-mono text-sm text-smidhus-bone-dim">Loading technical payload...</p>
          ) : null}

          {!loading && !content ? (
            <p className="font-sans text-sm leading-relaxed text-smidhus-bone-dim">
          ...
          {!loading && content ? (
            <div className="space-y-6">
              <section className="space-y-2">
                ...
                <p className="font-sans text-sm leading-relaxed text-smidhus-bone-dim">{content.summary}</p>
              </section>

              <section className="space-y-2">
                <h3 className="font-mono text-xs font-semibold tracking-[0.12em] text-[#00FF66]">ARCHITECTURE</h3>
                <ul className="list-disc space-y-2 pl-5 font-sans text-sm leading-relaxed text-smidhus-bone-dim">
              ...
              <section className="space-y-2">
                ...
                <pre className="overflow-x-auto border border-dashed border-[#1F242C] bg-[#0A0D10]/40 p-4 shadow-[0_0_30px_rgba(255,107,0,0.03)]">
                  <code className="font-mono text-xs leading-relaxed text-smidhus-bone-dim">{content.codeSample}</code>
                </pre>
              </section>
            </div>
          ) : null}
