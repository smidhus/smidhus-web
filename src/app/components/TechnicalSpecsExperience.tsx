      ...
      <div className={isDrawerOpen ? "relative z-20 opacity-30 blur-sm pointer-events-none" : "relative z-20"}>
        ...
        <section id="projects" className="relative z-20 px-6 pb-20 pt-6">
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
            <h2 className="font-mono text-xl font-bold uppercase tracking-[0.1em] text-zinc-100 sm:text-2xl">[THE FORGE OUTPUT]</h2>
            ...
            <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
              {PRODUCTS.map((product) => (
                ...
                >
                  ...
                  <p className="font-sans text-base leading-relaxed text-zinc-400">{product.description}</p>
